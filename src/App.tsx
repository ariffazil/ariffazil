    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-200 font-sans selection:bg-red-900/30 selection:text-red-200">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 pb-16">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-300 leading-relaxed max-w-xl mx-auto mb-10 text-base">
            Exploration geoscientist with 12+ years at <span className="text-white font-medium">PETRONAS</span>, 
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                ...
                12+ years of exploration experience with focus on the Malay Basin.
              </p>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 rounded-xl border border-gray-800 bg-gray-900/20">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-white font-medium mb-2">PETRONAS — Exploration Geoscientist (2013–present)</h4>
                  <ul className="space-y-2 text-gray-400 text-sm">
                    <li>• 12+ years in exploration geoscience, 100% success rate, zero dry wells</li>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="p-6 rounded-lg border border-gray-800 bg-gray-900/20">
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              ...
              methodology for artificial intelligence. arifOS provides 9 constitutional floors
      ...
      <footer className="py-12 border-t border-gray-800/50">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800/30 flex items-center justify-center">
            <p className="text-xs tracking-[0.3em] text-gray-700 uppercase font-mono">Ditempa Bukan Diberi — Forged, Not Given</p>
          </div>
        </div>
      </footer>
    </div>
